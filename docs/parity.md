...
| `settings/*`, `boot/*` | 15 | Layered config with provenance, the settings document under the harness home, boot resolution | Recompose at run time, a file watcher, per-namespace schemas, redaction, writing the document back | ② |
