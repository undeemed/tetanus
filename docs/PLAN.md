...
Supersedes the short scoping note ([scoping-superseded.md](scoping-superseded.md)) as the decision doc.
...
DECIDED (captain, 2026-08-18): option 2, at full-parity scope.
The header of this document records the decision; this section records that the question is closed.
Phase ① shipped in PR #1 and is described in [../ARCHITECTURE.md](../ARCHITECTURE.md).
