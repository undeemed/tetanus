 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-tool/tests/toolview-type-chain.client.spec.tsx
...
import type { ToolCallViewProps } from '../client/contract/slots.ts'
