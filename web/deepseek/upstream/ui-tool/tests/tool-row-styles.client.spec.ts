 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-tool/tests/tool-row-styles.client.spec.ts
...
const css = readFileSync(fileURLToPath(new URL('../client/tool/components/ToolRow.module.css', import.meta.url)), 'utf8')
