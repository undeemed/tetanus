 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/read-block.client.spec.tsx
...
import { DEFAULT_READ_MAX_LINES, ReadBlock, type ReadBlockLine } from '../index.ts'
