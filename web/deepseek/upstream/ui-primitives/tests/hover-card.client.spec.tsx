 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/hover-card.client.spec.tsx
...
import { POINTER_GRACE_MS } from '../pointer-grace.ts'
