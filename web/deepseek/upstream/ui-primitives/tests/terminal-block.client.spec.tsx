 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/terminal-block.client.spec.tsx
...
import { DEFAULT_TERMINAL_MAX_LINES, TerminalBlock } from '../index.ts'
