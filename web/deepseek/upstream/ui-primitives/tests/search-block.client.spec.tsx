 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/search-block.client.spec.tsx
...
import { DEFAULT_SEARCH_MAX_LINES, SearchBlock } from '../index.ts'
import type { SearchFileGroup } from '../index.ts'
