 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/code-block.client.spec.tsx
...
import { highlightToHtml } from '../markdown/highlight.ts'
