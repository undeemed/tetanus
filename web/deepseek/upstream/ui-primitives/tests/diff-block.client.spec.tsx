 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/diff-block.client.spec.tsx
...
import { DEFAULT_DIFF_MAX_LINES, DiffBlock, type DiffHunk } from '../index.ts'
