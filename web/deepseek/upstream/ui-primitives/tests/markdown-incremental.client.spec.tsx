 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/markdown-incremental.client.spec.tsx
...
import { IncrementalMarkdownParser } from '../markdown/incremental.ts'
import { parseGfm } from '../markdown/parse.ts'
...
describe('incremental streaming rendering', () => {
  for (const chunkSize of [1, 3, 7, 16]) {
    it(`matches a fresh render at every prefix (chunk=${chunkSize})`, { timeout: 180000 }, () => {
