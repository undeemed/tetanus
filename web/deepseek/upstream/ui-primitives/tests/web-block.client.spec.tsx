 ...
 * Vendored from deepseek-ai/deepseek-harness: packages/client/ui-primitives/tests/web-block.client.spec.tsx
...
import { WebBlock } from '../index.ts'
import type { WebSourceView } from '../index.ts'
