 ...
 * Vendored verbatim from deepseek-ai/deepseek-harness: packages/client/ui-conversation/src/client/chat/ChatView.tsx
 * The full notice is web/deepseek/upstream/LICENSE.
 *
 * MODIFIED by the tetanus project: the running-turn label was upstream's
 * product voice rather than its attribution, and now reads `Thinking`.
